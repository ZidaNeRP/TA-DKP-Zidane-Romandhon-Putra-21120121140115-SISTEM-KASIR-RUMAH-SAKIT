...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->cbNoStruck->Items->AddRange(gcnew cli::array< System::Object^  >(1) { L"Pilih Nomer" });
			this->cbNoStruck->Location = System::Drawing::Point(228, 305);
			...
			this->cbNoStruck->SelectedIndexChanged += gcnew System::EventHandler(this, &MyForm2::cbNoStruck_SelectedIndexChanged);
			// 
			// label5
			// 
